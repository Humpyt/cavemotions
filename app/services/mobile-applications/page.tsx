...
import { Smartphone, Sparkles, Zap, Layers, Globe, ArrowRight } from "lucide-react"
  ...
  const caseStudies = [
    {
      ...
      description: "Developed a cross-platform fitness app that increased user engagement by 78% and retention by 42%.",
    ...
    },
    {
      ...
      client: "Retail Chain",
      description:
        "Created a native shopping app that increased mobile sales by 156% and improved conversion rates by 34%.",
    ...
    },
    {
      ...
      description:
        "Built an AR app that allows customers to visualize products in their space, reducing returns by 26%.",
      image: "/placeholder.svg?height=400&width=600&text=AR App",
      color: "from-purple-500 to-violet-600",
    },
  ]
            ...
            >
              <div className="relative">
                <div className="overflow-hidden rounded-2xl shadow-xl">
                  <img
                    src="/placeholder.svg?height=400&width=500&text=Mobile Applications"
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              >
                {/* Connecting line */}
                {index < 3 && (
                  <div className="hidden md:block absolute top-10 left-full w-full h-0.5 bg-gradient-to-r from-amber-200 to-transparent z-0"></div>
                )}

                <div className="relative z-10 flex flex-col items-center text-center">
                  <div className="w-20 h-20 rounded-full bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center text-white text-2xl font-bold mb-6">
                    {process.step}
                  </div>
      ...
      <section className="py-24 md:py-32 px-4 md:px-6 lg:px-8 bg-gray-50 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-6xl relative">
          ...
          >
            ...
            <Button className="group relative overflow-hidden bg-amber-700 hover:bg-amber-800">
