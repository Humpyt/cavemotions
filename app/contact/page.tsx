...
export default function ContactPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen" ref={containerRef}>
      ...
      {/* Map Section */}
      <section className="py-24 md:py-32 px-4 md:px-6 lg:px-8 bg-gradient-to-b from-purple-950 to-black relative overflow-hidden">
        <div className="container relative mx-auto max-w-6xl z-10">
          <motion.div
          ...
          >
            ...
            <p className="text-lg text-white/70 max-w-3xl mx-auto">
              We're located in the heart of Kampala, Uganda. Come visit us!
            </p>
          </motion.div>

          <motion.div
            className="rounded-2xl overflow-hidden shadow-2xl h-96 bg-white/5 backdrop-blur-sm border border-white/10 relative"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.6, delay: 0.2 }}
          ...
          >
            ...
            <div className="w-full h-full flex items-center justify-center relative overflow-hidden">
              ...
              <div className="relative z-10 text-center p-8 bg-black/50 backdrop-blur-md rounded-lg shadow-lg border border-white/10 max-w-md">
                <MapPin className="h-10 w-10 text-purple-400 mx-auto mb-4" />
                <h3 className="text-xl font-bold mb-2 text-white">Cave Motions Headquarters</h3>
                <p className="text-white/80 mb-4">Bugolobi, Kampala, Uganda</p>
                <Button className="bg-gradient-to-r from-purple-500 to-violet-600 hover:from-purple-600 hover:to-violet-700 rounded-full px-6">
                  Get Directions
